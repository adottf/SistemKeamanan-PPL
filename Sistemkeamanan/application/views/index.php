...
<head>
	...
	<body data-preloader="2">
			...
			<nav class="navbar navbar-white navbar-absolute navbar-fixed">
				<div class="container">
					<a class="navbar-brand" href="#">
						<h6 class="line-height-100"><font color="#00000">Wisma Arum <br><font size="2" class="font-weight-light">Sistem Informasi Monitoring</font> </font></h6>
									...
									<div class="row">
										<div class="col-12 col-md-6">
											<ul class="list-unstyled">
												<li>
													<h6 class="font-weight-normal uppercase letter-spacing-2px"><a class="hyperlink-7" href="index.php">Portal</a></h6>
												</li>
												<li>
		...
		<!-- Home section -->
		<div class="section-2xl bg-image parallax" style="background-image: url(assets/images/bg-wisma.jpg)">
			<div class="bg-black-01">
				<div class="container text-center">
					<div class="row">
						<div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2">
							<h4 class="font-weight-light margin-bottom-20" ><font color="#00000">Hallo Pengguna!</font></h4>
							<h1 class="font-weight-normal line-height-100"><font color="#00000">Selamat Datang di Portal Utama Sistem Informasi Monitoring Keamanan Lock System</font></h1>
							<a class="button button-lg button-lg button-reveal-right-dark button-rounded button-border-1px margin-top-30 scrolldown" href="login.php">Login &nbsp; <i class="ti-arrow-right"></i></a>
						</div>
					</div><!-- end row -->
				</div><!-- end container -->
			</div>
