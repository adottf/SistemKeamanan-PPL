					...
					<a class="navbar-brand" href="#">
						...
						<nav>
                            <ul>
                                ...
                                <li><a href="home.php">Setting</a></li>
                                <li><a href="home.php">UbahPassword</a></li>
                            </ul>
                        </nav>
					</a>
									...
									<div class="row">
										<div class="col-12 col-md-6">
											<ul class="list-unstyled">
												<li>
													<h6 class="font-weight-normal uppercase letter-spacing-2px"><a class="hyperlink-7" href="index.html">Portal</a></h6>
												</li>
												<li>
													<h6 class="font-weight-normal uppercase letter-spacing-2px"><a class="hyperlink-7" href="login.html">Login</a></h6>
												</li>
											</ul>
										</div>
										<div class="col-12 col-md-6">
